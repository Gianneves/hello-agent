...
export default function Home() {
  ...
  return (
    <div className="min-h-dvh w-ful bg-zinc-50">
      <div className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col px-4 pb-24 pt-8">
        <header className="mb-4">
          <h1 className="text-x1 font-semibold tracking-tight">Hello Agent - Ask anything</h1>
        </header>
              ...
              answers.length === 0 ?
                (<p className="text-sm text-zinc-600">
                  ...
                  answers.map((ans, index) => (
                    <div key={index} className="rounded-x1 border border-zinc-200 p-3">
